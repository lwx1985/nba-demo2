...
class Season2017(models.Model):
    ...
    ps_g = models.FloatField(db_column='PSG', blank=True, null=True)  # Field name made lowercase. Field renamed to remove unsuitable characters.
...
class Teams(models.Model):
    ...
    region = models.CharField(db_column='\r\nZone', max_length=255, blank=True, null=True)  # Field name made lowercase. Field renamed to remove unsuitable characters. Field renamed because it started with '_'.
    chinese_name = models.CharField(db_column='ChineseName', max_length=255, blank=True, null=True)  # Field name made lowercase.
    win = models.IntegerField(db_column='win', blank=True, null=True)
    lose = models.IntegerField(db_column='lose', blank=True, null=True)
    class Meta:
        managed = False
        db_table = 'teams'
...
class League(models.Model):
    ...
    efgp = models.FloatField(blank=True, null=True)
...
class Games(models.Model):
    ...
    h_ast = models.IntegerField(blank=True, null=True)
    h_trb = models.IntegerField(blank=True, null=True)
    ...
    a_ast = models.IntegerField(blank=True, null=True)
    a_trb = models.IntegerField(blank=True, null=True)
